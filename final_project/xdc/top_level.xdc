...
set_property PACKAGE_PIN M16 [ get_ports {sd_dat[0]} ]
set_property PACKAGE_PIN M17 [ get_ports {sd_dat[1]} ]
set_property PACKAGE_PIN M18 [ get_ports {sd_dat[2]} ]
set_property PACKAGE_PIN N18 [ get_ports {sd_dat[3]} ]
